...
class LambdaProvisioner(BaseProvisioner):
    ...
    def _inject_env_vars(self, lam: object, target_name: str, env: EnvironmentModel) -> None:
        ...
        overrides = {
            ...
            # DynamoDB table names — shared across all environments (per audio update)
            "CatEncounter_Users_Table": "CatEncounter_Users_Table",
            "CatEncounter_Membership_Table": "catEncounter_Membership_Table",
            "CatEncounter_StaffTable": "catEncounter_StaffTable",
            "Thought_Table": "Thought_Table",
            "Picture_Table": "Picture_Table",
            "CatEncounter_Event_Table": "catEncounter_Event_Table",
            "Event_Landing_Notes": "Event_Landing_Notes",
            "Member_Landing_Notes": "Member_Landing_Notes",
            "Staff_Landing_Notes": "Staff_Landing_Notes",
            "CatEncounter_Dashboard_MessageBoard": "catEncounter_Dashboard_MessageBoard",
            "CheckIn_Table": "CheckIn_Table",
            "StaffCheckIn_Table": "StaffCheckIn_Table",
            "CatEncounter_RecommendedEvent": "CatEncounter_RecommendedEvent",
            "catEncourageStaffAssignments": "catEncourageStaffAssignments",
            "Catalyst_CompConfig": "Catalyst_CompConfig",
