...
class LambdaProvisioner(BaseProvisioner):
    ...
    def _inject_env_vars(self, lam: object, target_name: str, env: EnvironmentModel) -> None:
        ...
        overrides = {
            ...
            "USERS_TABLE": "CatEncounter_Users_Table",
            "MEMBERSHIP_TABLE": "catEncounter_Membership_Table",
            "STAFF_TABLE": "catEncounter_StaffTable",
            "THOUGHT_TABLE": "Thought_Table",
            "PICTURE_TABLE": "Picture_Table",
            "EVENT_TABLE": "catEncounter_Event_Table",
            "EVENT_LANDING_NOTES_TABLE": "Event_Landing_Notes",
            "MEMBER_LANDING_NOTES_TABLE": "Member_Landing_Notes",
            "STAFF_LANDING_NOTES_TABLE": "Staff_Landing_Notes",
            "MESSAGE_BOARD_TABLE": "catEncounter_Dashboard_MessageBoard",
            "CHECKIN_TABLE": "CheckIn_Table",
            "STAFF_CHECKIN_TABLE": "StaffCheckIn_Table",
            "RECOMMENDED_EVENT_TABLE": "CatEncounter_RecommendedEvent",
            "STAFF_ASSIGNMENTS_TABLE": "catEncourageStaffAssignments",
            "COMP_CONFIG_TABLE": "Catalyst_CompConfig",
            "ASSESSMENTS_TABLE": "memberAssessments",
            "MEMBER_PLANS_TABLE": "memberPlans",
            "FEELING_METER_TABLE": "FeelingMeter",
            # Other config
